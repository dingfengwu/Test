...
// 版权所有。
//
// 文件名：OAuthAuthorizationServerProvider.cs
// 文件功能描述：
// 描述内容
//
// 创建人  ：WDF
...
namespace Kehu1688.Framework.Permission.Service
{
    ...
    public class OAuthAuthorizationServerProvider : IOAuthAuthorizationServerProvider
    {
        ...
        /// with the access token. The application should take appropriate measures to ensure that the endpoint isn抰 abused by malicious callers.
